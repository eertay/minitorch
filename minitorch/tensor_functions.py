...
class Mul(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, Tensor]:
        ...
        # return SimpleBackend.mul_zip(b, grad_output), SimpleBackend.mul_zip(a, grad_output)
...
class Sigmoid(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        # b = ctx.saved_values[0]
        # b = ctx.saved_values[0]
        # # return SimpleBackend.mul_zip(grad_output, SimpleBackend.mul_zip(b, SimpleBackend.add_zip(tensor_fromlist([1]), SimpleBackend.neg_map(b))))
        # return SimpleBackend.mul_zip(grad_output, SimpleBackend.mul_zip(b, SimpleBackend.add_zip(tensor([1]), SimpleBackend.neg_map(b))))
        sig: Tensor = ctx.saved_values[0]
...
class ReLU(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        ...
        # return SimpleBackend.relu_back_zip(a, grad_output)
        (a,) = ctx.saved_values
        # b = ctx.saved_values[0]
        # return a.f.relu_back_zip(b, grad_output)
...
class Log(Function):
    ...
    def forward(ctx: Context, t1: Tensor) -> Tensor:
        # TODO: Implement for Task 2.3.
        ctx.save_for_backward(t1)
        # return SimpleBackend.log_map(t1)
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        # a = ctx.saved_values
        # return SimpleBackend.log_back_zip(a, grad_output)
        (a,) = ctx.saved_values
...
class Permute(Function):
    ...
    def forward(ctx: Context, a: Tensor, order: Tensor) -> Tensor:
        ...
        # a._tensor.permute(*order.to_numpy().astype(int))
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tuple[Tensor, float]:
        ...
        # # order_int = order_np.astype(int)
        # grad_output._tensor.permute(*order.to_numpy().astype(int))
        # # grad_output._tensor.permute(*order_int )
        # return grad_output, 0
